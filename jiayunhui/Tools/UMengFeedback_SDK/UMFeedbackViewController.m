...
//    frame.origin.y = self.topViewOffset + originY;
    ...
    NSInteger _navButtonHeight = needNavButton ?64.f : 0.f;
...
- (void)setTitleLabel:(NSString *)titleStr{
    ...
    //titleLabel.backgroundColor = [UIColor bla];
...
//        UIBarButtonItem *right=[[UIBarButtonItem alloc]initWithTitle:@"       " style:UIBarButtonItemStyleBordered target:nil action:nil];
