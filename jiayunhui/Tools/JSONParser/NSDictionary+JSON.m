...
-(NSString *)JSONStringWithBase64WithUTF8
{
    ...
    NSString *sickJsonStr=[jsonStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    
    NSData *sickData=[sickJsonStr dataUsingEncoding:NSUTF8StringEncoding];
